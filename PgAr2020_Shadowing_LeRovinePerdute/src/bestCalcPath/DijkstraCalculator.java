...
public class DijkstraCalculator {
     ...
     * 
     * @param cities the graph on which execute the algorithm
     */
     ...
     * 
     * @param distances       the distances of all the cities from the origin
     * @param remainderCities the city which are not "calculated" yet
     * @return
     */
     ...
     * 
     * @param source      the source from which start the calculations
     * @param destination the destination to reach
     * @param type        the type of the cost function to use
     */
